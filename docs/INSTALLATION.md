...
1. Download and install the **zDEV archive** from the [UE4SS experimental-latest release](https://github.com/UE4SS-RE/RE-UE4SS/releases/tag/experimental-latest). Release v0.6.7 was tested with UE4SS Git SHA `c2ac2464`. Stable, non-zDEV, and other experimental commits are not verified.
...
Release v0.6.7 was tested with Drive Beyond Horizons Steam build `24071320`.
